                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php 
                                    ...
                                    $viewCategory = mysqli_fetch_array($getCategoryById);
                                ...
                                <td>
                                    ...
                                    <a href="delete_sms.php?id=<?php echo $row['id']; ?>" class="label label-important" onclick="return confirm('Are you sure you want to delete this?')"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
