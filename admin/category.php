                        ...
                        while($row = mysqli_fetch_array($query)){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_category.php?id=<?php echo $row['id']; ?>" class="label label-important " onclick="return confirm('Are you sure you want to delete this?')"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
