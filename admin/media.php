                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_media.php?id=<?php echo $row['id']; ?>" class="label label-important" onclick="return confirm('Are you sure you want to delete this item?')"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
